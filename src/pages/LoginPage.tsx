          ...
          {forgotSent ? (
            ...
            <div className="space-y-3">
              <div>
                ...
                <input className="solar-input" type="email" placeholder="seu@email.com"
                  value={forgotEmail} onChange={e => setForgotEmail(e.target.value)} />
              </div>
              <button className="w-full solar-btn-primary" onClick={handleForgot}>
      ...
      <div className="max-w-md w-full solar-card p-8 space-y-6 animate-fade-in-up">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input className="solar-input" type="password" placeholder="••••••••"
              value={password}
