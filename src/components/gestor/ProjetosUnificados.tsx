...
export default function ProjetosUnificados({
  ...
  const mapProjetoToDados = (p: Projeto) => ({
    ...
    origem: 'projeto',
    dados_paineis: null, dados_inversor: null,
    tipo_inversor: (p as any).inversor?.tipo || null,
    cabo_usado: (p as any).cabo_usado || null,
    modelo_placa: null, modelo_inversor: null,
    fornecedor: null,
    projeto_enviado_em: (p as any).projeto_enviado_em || null,
    projeto_aprovado: (p as any).projeto_aprovado || null,
    satisfacao: (p as any).satisfacao ?? null,
    status: p.status || null,
    congelado: (p as any).congelado ?? null,
    congelado_ate: (p as any).congelado_ate || null,
    motivo_congelamento: (p as any).motivo_congelamento || null,
    codigo_rastreamento: (p as any).codigo_rastreamento || null,
    layout_url: (p as any).layout_url || null,
    local_entrega: (p as any).local_entrega || null,
    projeto_id: null,
